...
// instead of `sdk.NewNationalizeSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *NationalizeSDK  { return NewNationalizeSDK(nil) }
func Test() *NationalizeSDK { return TestSDK(nil, nil) }
