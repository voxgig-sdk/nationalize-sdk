...
func (sdk *NationalizeSDK) OptionsMap() map[string]any {
...
func (sdk *NationalizeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *NationalizeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *NationalizeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NationalizeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *NationalizeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *NationalizeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("NationalizeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *NationalizeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NationalizeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("NationalizeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
