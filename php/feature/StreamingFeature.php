...
// Nationalize SDK streaming feature
...
class NationalizeStreamingFeature extends NationalizeBaseFeature
{
    ...
    private function _iterate(NationalizeResult $result): \Generator
    {
    ...
    private function _streamable(NationalizeContext $ctx): bool
    {
