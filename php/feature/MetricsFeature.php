...
// Nationalize SDK metrics feature
...
class NationalizeMetricsFeature extends NationalizeBaseFeature
{
    ...
    private function _record(NationalizeContext $ctx, bool $ok): void
    {
