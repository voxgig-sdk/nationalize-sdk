...
// Nationalize SDK netsim feature
...
class NationalizeNetsimFeature extends NationalizeBaseFeature
{
    ...
    private function _simulate(NationalizeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NationalizeContext $ctx, array $applied): void
    {
        $client = $this->client;
