...
// Nationalize SDK clienttrack feature
...
class NationalizeClienttrackFeature extends NationalizeBaseFeature
{
    ...
    public function PostConstruct(NationalizeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Nationalize-SDK';
