...
class NationalizeRbacFeature extends NationalizeBaseFeature
{
    ...
    private function _required(NationalizeContext $ctx): ?string
    {
    ...
    private function _reject(NationalizeContext $ctx, string $required): void
    {
    ...
    private function _track(NationalizeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
