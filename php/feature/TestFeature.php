...
// Nationalize SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NationalizeTestFeature extends NationalizeBaseFeature
{
    ...
    public function init(NationalizeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NationalizeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = NationalizeParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NationalizeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NationalizeContext $ctx, $op, $args): array
    {
