...
// Nationalize SDK telemetry feature
...
class NationalizeTelemetryFeature extends NationalizeBaseFeature
{
    ...
    private function _close(NationalizeContext $ctx, bool $ok): void
    {
