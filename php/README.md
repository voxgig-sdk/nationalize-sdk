...
The PHP SDK for the Nationalize API — an entity-oriented client using PHP conventions.
...
```php
require_once 'nationalize_sdk.php';
$client = new NationalizeSDK($options);
```
...
```
php/
├── nationalize_sdk.php          -- Main SDK class
...
The main class (`nationalize_sdk.php`) exports the SDK class
