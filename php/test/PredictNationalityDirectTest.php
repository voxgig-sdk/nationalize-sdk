...
class PredictNationalityDirectTest extends TestCase
{
    public function test_direct_load_predict_nationality(): void
    {
        $setup = predict_nationality_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-predict_nationality", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
