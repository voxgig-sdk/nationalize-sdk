...
class NationalizeTestRunner
{
    ...
    {
        $live = self::getenv('NATIONALIZE_TEST_LIVE');
        $override = self::getenv('NATIONALIZE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NATIONALIZE_TEST_EXPLAIN');
...
class_alias('NationalizeTestRunner', 'Runner');
class_alias('NationalizeHelpers', 'Helpers');
