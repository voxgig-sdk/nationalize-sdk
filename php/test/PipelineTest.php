...
{
    private static function utility(): NationalizeUtility
    {
        return new NationalizeUtility();
    }
    ...
    private static function ctx(array $over = []): NationalizeContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NationalizeContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NationalizeOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NationalizeError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NationalizeOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NationalizeMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NationalizeOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NationalizeMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NationalizeOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NationalizeMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NationalizeSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NationalizeMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            ...
            'result' => new NationalizeResult([]),
        ]);
        [, $err] = NationalizeMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NationalizeSpec([]),
            'response' => null,
            'result' => new NationalizeResult([]),
        ]);
        [, $err] = NationalizeMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NationalizeSpec(['step' => 's']),
            'response' => new NationalizeResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NationalizeResult([]),
        ]);
        [, $err] = NationalizeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NationalizeSpec(['step' => 's']),
            'response' => new NationalizeResponse(self::resp(200, ['v' => 1])),
            'result' => new NationalizeResult([]),
        ]);
        [, $err] = NationalizeMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NationalizeSpec(['step' => 's']),
            'response' => new NationalizeResponse(self::resp(200, ['v' => 2])),
            'result' => new NationalizeResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NationalizeMakeResponse::call($ctx);
    ...
    {
        $preset = new NationalizeResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NationalizeSpec([]),
            'response' => new NationalizeResponse([]),
            'result' => new NationalizeResult([]),
        ...
        [$got, $err] = NationalizeMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NationalizeResult([])]);
        [, $err] = NationalizeMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NationalizeSpec([]), 'result' => null]);
        [, $err] = NationalizeMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NationalizeSpec(['step' => 's']),
            'result' => new NationalizeResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NationalizeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NationalizeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NationalizeSpec(['step' => 's']),
            'result' => new NationalizeResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NationalizeOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NationalizeMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NationalizeResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NationalizeSpec([]),
            'result' => new NationalizeResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NationalizeMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NationalizeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NationalizeError('boom', 'boom');
        $utility->fetcher = function (NationalizeContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NationalizeSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NationalizeMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NationalizeContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NationalizeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NationalizeResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        NationalizeMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NationalizeContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NationalizeSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NationalizeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NationalizeResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NationalizeSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NationalizeMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NationalizeMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NationalizeMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NationalizeResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NationalizeDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NationalizeResult(['ok' => false])]);
        $this->expectException(NationalizeError::class);
        NationalizeDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NationalizeResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NationalizeMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NationalizeMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NationalizeBaseFeature();
        $b = new NationalizeBaseFeature();
        NationalizeFeatureAdd::call($ctx, $a);
        NationalizeFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NationalizeBaseFeature
    {
        $f = new NationalizeBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NationalizeFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NationalizeContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NationalizeSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NationalizePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        NationalizePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NationalizeResponse(['headers' => null]),
            'result' => new NationalizeResult([]),
        ]);
        NationalizeResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        NationalizeResultBody::call($ctx);
