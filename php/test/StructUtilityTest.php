...
// Nationalize SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NationalizeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NationalizeOmni::structfix($now, Struct::undef()))
                        !== json_encode(NationalizeOmni::structfix($val, Struct::undef()))) {
