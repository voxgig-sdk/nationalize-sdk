...
// Nationalize SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NationalizeSDK::test)
...
{
    private const SDK_CLASS = 'NationalizeSDK';
    ...
    private const SDK_BASE = 'nationalize_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../nationalize_sdk.php';
