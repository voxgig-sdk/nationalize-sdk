...
// Nationalize SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NationalizeMakeRequest
{
    public static function call(NationalizeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NationalizeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NationalizeResponse($fetched);
        } else {
