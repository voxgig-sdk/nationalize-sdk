...
// Nationalize SDK utility: fetcher

class NationalizeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NationalizeSDK/1.0)';
    ...
    public static function call(NationalizeContext $ctx, string $fullurl, array $fetchdef): array
    {
