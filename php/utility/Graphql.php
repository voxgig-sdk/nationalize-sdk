...
// Nationalize SDK utility: graphql
//
...
class NationalizeGraphql
{
    ...
    // equivalent.
    public static function body(NationalizeContext $ctx): mixed
    {
    ...
    public static function errors(NationalizeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
