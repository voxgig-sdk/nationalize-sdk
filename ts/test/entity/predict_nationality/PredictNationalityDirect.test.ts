...
describe('PredictNationalityDirect', async () => {
  ...
  test('direct-load-predict_nationality', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-predict_nationality', setup.live)) return
