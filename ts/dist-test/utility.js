...
function envOverride(m) {
    if ('TRUE' === process.env.NATIONALIZE_TEST_LIVE ||
        'TRUE' === process.env.NATIONALIZE_TEST_OVERRIDE) {
    ...
    m.NATIONALIZE_TEST_EXPLAIN = process.env.NATIONALIZE_TEST_EXPLAIN || m.NATIONALIZE_TEST_EXPLAIN;
    return m;
}
