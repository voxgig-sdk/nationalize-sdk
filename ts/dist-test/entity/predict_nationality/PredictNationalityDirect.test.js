...
(0, node_test_1.describe)('PredictNationalityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NationalizeSDK({
    ...
    (0, node_test_1.test)('direct-load-predict_nationality', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-predict_nationality', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NationalizeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.NATIONALIZE_APIKEY,
        }));
        let idmap = env['NATIONALIZE_TEST_PREDICT_NATIONALITY_ENTID'];
    ...
    const client = new __1.NationalizeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PredictNationalityDirect.test.js.map