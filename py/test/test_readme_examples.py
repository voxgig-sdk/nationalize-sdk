# Nationalize SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NationalizeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NationalizeSDK(...) and NationalizeSDK.test(...) become
#      NationalizeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nationalize_sdk"
_SDK_CLASS = "NationalizeSDK"
...
_ENTITIES = {
    "PredictNationality": "predict_nationality",
}
