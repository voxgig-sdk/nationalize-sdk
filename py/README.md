# Nationalize Python SDK



The Python SDK for the Nationalize API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.PredictNationality()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/nationalize-sdk/releases)) or
...
```
py/
├── nationalize_sdk.py         -- Main SDK module
