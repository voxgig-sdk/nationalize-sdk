...
from nationalize_sdk.nationalize_types import (
    PredictNationality,
    PredictNationalityLoadMatch,
)
...
class PredictNationalityEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PredictNationalityEntity(self._client, opts)
    ...
    def data_get(self) -> PredictNationality:
    ...
    def match_get(self) -> PredictNationality:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PredictNationality:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PredictNationality().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
