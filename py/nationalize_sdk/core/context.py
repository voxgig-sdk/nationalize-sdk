...
from nationalize_sdk.core.helpers import get_ctx_prop, to_map
...
class NationalizeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, NationalizeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NationalizeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NationalizeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NationalizeError(code, msg, self)
