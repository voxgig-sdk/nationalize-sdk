...
from nationalize_sdk.utility import register

# Load features
from nationalize_sdk.feature.base_feature import NationalizeBaseFeature
from nationalize_sdk.features import _has_feature, _make_feature
...
class NationalizeSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = NationalizeUtility()
        self._utility = utility

        from nationalize_sdk.config import shared_config
    ...
    def get_utility(self):
        return NationalizeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NationalizeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def PredictNationality(self, data=None) -> "PredictNationalityEntity":
        ...
        from nationalize_sdk.entity.predict_nationality_entity import PredictNationalityEntity
