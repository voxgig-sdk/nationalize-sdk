...
module NationalizeTestRunner
  ...
  def self.env_override(m)
    live = getenv("NATIONALIZE_TEST_LIVE")
    override = getenv("NATIONALIZE_TEST_OVERRIDE")
    ...
    explain = getenv("NATIONALIZE_TEST_EXPLAIN")
    m["NATIONALIZE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = NationalizeTestRunner
Helpers = NationalizeHelpers
Vs = VoxgigStruct
