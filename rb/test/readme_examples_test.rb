...
#      offline in seeded test mode (NationalizeSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Nationalize_sdk.rb")
  SDK_CLASS = "NationalizeSDK"
