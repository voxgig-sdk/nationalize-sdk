...
local PredictNationalityEntity = {}
PredictNationalityEntity.__index = PredictNationalityEntity


function PredictNationalityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PredictNationalityEntity)
  self._name = "predict_nationality"
  self._client = client
...
function PredictNationalityEntity:get_name()
  return self._name
end


function PredictNationalityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PredictNationalityEntity.new(self._client, opts)
end
...
function PredictNationalityEntity:mark_deleted()
  self._deleted = true
end


function PredictNationalityEntity:deleted()
  return true == self._deleted
end


function PredictNationalityEntity:data_set(args)
  if args ~= nil then
...
function PredictNationalityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PredictNationalityEntity:match_set(args)
  if args ~= nil then
...
function PredictNationalityEntity:match_get()
...
function PredictNationalityEntity:stream(action, args, callopts)
...
function PredictNationalityEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PredictNationalityEntity
