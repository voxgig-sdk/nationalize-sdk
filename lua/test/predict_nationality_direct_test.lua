...
describe("PredictNationalityDirect", function()
  it("should direct-load-predict_nationality", function()
    local setup = predict_nationality_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-predict_nationality", setup.live and "live" or "unit")
...
function predict_nationality_direct_setup(mockres)
