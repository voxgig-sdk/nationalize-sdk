...
func registerSDKWords(r *eng.Registry, client *sdk.NationalizeSDK) {
...
func runOp(client *sdk.NationalizeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
