...
AQL-driven CLI and REPL for the Nationalize SDK. Positional arguments are
...
./nationalize-cli list predict_nationality
./nationalize-cli load 1 predict_nationality
./nationalize-cli load '{id:1}' predict_nationality
