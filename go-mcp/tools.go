...
type Args struct {
	Entity string         `json:"entity" jsonschema:"predict_nationality"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NationalizeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "nationalize_list",
		Description: "List records from Nationalize. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "nationalize_load",
		Description: "Load a single record from Nationalize. " +
...
func runOp(client *sdk.NationalizeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NationalizeSDK, name string) (sdk.NationalizeEntity, error) {
	switch strings.ToLower(name) {
	case "predict_nationality":
		return client.PredictNationality(nil), nil
