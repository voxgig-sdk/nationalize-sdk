// Command Nationalize-mcp is an MCP server exposing the Nationalize
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Nationalize_list  — list records of an entity
//	Nationalize_load  — load a single record of an entity
//
