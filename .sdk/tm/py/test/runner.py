...
class NationalizeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NationalizeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = NationalizeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = NationalizeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
