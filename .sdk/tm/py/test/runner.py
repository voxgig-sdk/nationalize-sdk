...
class NationalizeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NationalizeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = NationalizeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = NationalizeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
