...
// Nationalize SDK ratelimit feature
...
class NationalizeRatelimitFeature extends NationalizeBaseFeature
{
    ...
    private function _acquire(NationalizeContext $ctx): void
    {
    ...
    private function _track(NationalizeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
