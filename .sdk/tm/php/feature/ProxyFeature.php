...
class NationalizeProxyFeature extends NationalizeBaseFeature
{
    ...
    public function init(NationalizeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NationalizeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
