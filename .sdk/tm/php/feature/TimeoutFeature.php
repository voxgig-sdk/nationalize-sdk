...
// Nationalize SDK timeout feature
...
class NationalizeTimeoutFeature extends NationalizeBaseFeature
{
    ...
    private function _with_timeout(NationalizeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NationalizeContext $_ctx, float $ms): void
    {
        $client = $this->client;
