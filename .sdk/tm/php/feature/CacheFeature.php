...
class NationalizeCacheFeature extends NationalizeBaseFeature
{
    ...
    private function _through(NationalizeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
