...
|---|---|---|
| `ts/` | @voxgig-sdk/nationalize-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nationalize-sdk \
      --repository voxgig-sdk/nationalize-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nationalize-sdk` shows it, and
`npm trust revoke @voxgig-sdk/nationalize-sdk --id=<id>` removes it.
