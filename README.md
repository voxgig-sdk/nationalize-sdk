...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/nationalize` | `npm install @voxgig-sdk/nationalize` |
| Python | `voxgig-sdk-nationalize` | `pip install voxgig-sdk-nationalize` |
| PHP | `voxgig-sdk/nationalize` | `composer require voxgig-sdk/nationalize` |
| Golang | `github.com/voxgig-sdk/nationalize-sdk/go` | `go get github.com/voxgig-sdk/nationalize-sdk/go` |
| Ruby | `voxgig-sdk-nationalize` | `gem install voxgig-sdk-nationalize` |
| Lua | `voxgig-sdk-nationalize` | `luarocks install voxgig-sdk-nationalize` |
